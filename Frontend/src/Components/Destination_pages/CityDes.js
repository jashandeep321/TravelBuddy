...
const data = [
    ...
    { 
        ...
        description: "Unparalleled biodiversity and a haven for adventure seekers.", 
    ...
    { 
        id: 6, 
        name: "Yellowstone", 
        description: "Home to geothermal wonders like Old Faithful and a variety of wildlife.", 
        location: "USA", 
        image: yellowstoneimg, 
        category: "nature" 
    },
    { 
        id: 7, 
        name: "Tokyo", 
        description: "A bustling metropolis where futuristic technology meets ancient traditions.", 
        location: "Japan", 
        image: tokyoimg, 
        category: "city" 
    },
    { 
        id: 8, 
        name: "Patagonia", 
        description: "Rugged landscapes and breathtaking vistas await in this outdoor paradise.", 
    ...
    { 
        id: 9, 
        name: "Swiss Alps", 
        description: "Majestic peaks and world-class skiing make it a must-visit destination.", 
    ...
    { 
        id: 10, 
        name: "Hawaii", 
        description: "A tropical paradise with diverse landscapes and stunning beaches.", 
        location: "USA", 
        image: hawaiiimg, 
        category: "beach" 
    },
    { 
        id: 11, 
        name: "Maldives", 
        description: "Known for luxurious overwater villas and crystal-clear waters.", 
    ...
    { 
        id: 12, 
        name: "Himalayas", 
        description: "A mountain range with unmatched scenic beauty and thrilling adventures.", 
        location: "Asia", 
        image: himalayasimg, 
        category: "mountain" 
    },
    { 
        id: 13, 
        name: "Seoul", 
        description: "A vibrant city blending traditional palaces with K-pop culture.", 
    ...
    { 
        id: 14, 
        name: "Rome", 
        description: "An open-air museum of ancient ruins and Renaissance art.", 
        location: "Italy", 
        image: romeimg, 
        category: "city" 
    }
