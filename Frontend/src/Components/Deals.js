...
//       description: 'Register and get Discount on first bookings with us',
//       imageUrl: newuser,
//     },
//     {
//       id: 2,
...
//       description: 'Enjoy free cab bookings with us',
//       imageUrl: cab, 
//     },
//     {
//     id: 5,
    ...
    <div>
      <div className="container deals-page">
        ...
        <p className="lead text-muted">
          "Travel More for Less!"<br />
          Get ready for your next trip with our fantastic travel deals.<br />
          From family vacations to romantic getaways, find the perfect offer that fits your budget.<br />
          Save on flights, hotels, and activities - your dream destination is just a click away!
        </p>

        <img src={dealimage} alt="dealimage" className="img-fluid dealimage my-4" />

        <div className="row">
          {offers.map((offer) => (
            <div className="col-12 col-sm-6 col-lg-3 mb-4" key={offer.id}>
              <div className="card h-100 shadow-sm offer-card">
                <img src={offer.imageUrl} alt={offer.title} className="card-img-top offer-image" />
                <div className="card-body offer-info">
                  <h5 className="card-title offer-title">{offer.title}</h5>
                  <p className="card-text offer-description">{offer.description}</p>
                </div>
              </div>
            </div>
          ))}
